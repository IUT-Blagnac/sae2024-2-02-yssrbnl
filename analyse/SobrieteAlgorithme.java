...
/**
 * La classe SobrieteAlgorithme mesure et affiche la consommation des ressources
 * (temps CPU et mémoire utilisée) pour différents algorithmes de compression
 * et décompression de chaînes de caractères.
 */
public class SobrieteAlgorithme {
    ...
    public static void main(String[] args) {
        // Différentes tailles d'entrées à tester
        String[] entrees = {
                "",
                "abc",
                "abbccc",
        ...
        // Descriptions des algorithmes à tester
        String[] descriptions = {
                "RLE",
                "RLE avec itération",
                "unRLE",
        ...
        // Différents algorithmes à tester
        ...
        // Mesurer et afficher les ressources CPU et mémoire utilisées pour chaque algorithme
    ...
    /**
     * Mesure la consommation des ressources (temps CPU et mémoire utilisée)
     * pour un algorithme donné.
     *
     * @param algorithme L'algorithme à mesurer.
     * @return Un tableau contenant le temps CPU en microsecondes et la mémoire utilisée en kilooctets.
     */
